...
include '../expired/check-expired.php';
...
$hasExpiredProducts = count($expiredProducts) > 0;
$conn->close();
?>
...
<body>
    <div class="Dashboardwrapper">
        <div class="sidebar">
            ...
            <p><a href="../supliers/suppliers.php">Suppliers</a></p>
        ...
        <div class="dashboard">
            <div class="dashboard-header"><h3 class="dashboard-header">Dashboard</h3></div>
            ...
            <div class="dashboard-content">
                ...
                <div class="expired">
                    <p>Expired</p>
                    <?php if ($hasExpiredProducts): ?>
                        <p>You have expired products!</p>
                    <?php else: ?>
                        <p>No expired products found.</p>
                    <?php endif; ?>
                    <a href="../expired/expired.php"><p>view</p></a>
                </div>
                <div class="invoice">
            ...
            <div class="subdashboardcontent">
                <div class="suppliers"><p>Suppliers</p><b><?php echo $supplierCount;?></b></div>
