...
<body>
    <div class="Dashboardwrapper">
        <div class="sidebar">
            ...
            <p><a href="#">Creditors</a></p> <br>
            <p><a href="logout.php">Logout</a></p>
        </div>
        <div class="dashboard">
            <div><h3 class="dashboard-header">Creditors</h3></div>
            <div><p>Creditors information</p></div>
            <div class="add-button"><button>Add creditor</button></div>
